...
class MongoServerExtensionDropAfterAllTest {
    ...
    @RegisterExtension
    static final MongoServerExtension MONGO_SERVER_EXTENSION = new MongoServerExtension(DropTime.AFTER_ALL);
    ...
    @Test
    @Order(2)
    void shouldSeePreviousDocument() {
    ...
    @Test
    @Order(3)
    void shouldSeePreviousThreeDocuments() {
        var documents = ImmutableList.copyOf(testCollection.find());
